  ...
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            ...
            <h1  className='text-[8vw] font-bold -mb-10 leading-none font-["Founders_Grotesk"]' >EYE-</h1>
            <h1 className='text-[8vw] font-bold -mb-10 mt-6 leading-none font-["Founders_Grotesk"]' >OPENING</h1>
     ...
     <div className='w-1/2'>
     <h1  className='text-[6vw] font-bold -mb-10 leading-none font-["Founders_Grotesk"]' >PRESENTATIONS</h1>
     <div className='dets mt-20 font-["Neue_Montreal"]'>
        ...
        <a className='block text-xl ' href="#">Dribble</a>
